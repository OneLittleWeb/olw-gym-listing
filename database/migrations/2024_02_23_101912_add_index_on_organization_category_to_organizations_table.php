...
class AddIndexOnOrganizationCategoryToOrganizationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('organizations', function (Blueprint $table) {
            $table->index(['organization_category'], 'organizations_organization_category_index');
            $table->index(['organization_category_slug'], 'organizations_organization_category_slug_index');
            ...
            $table->index(['organization_address'], 'organizations_organization_address_index');
