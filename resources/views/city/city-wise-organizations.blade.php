                                        ...
                                        @if($category->organization_category && $category->organization_category_slug != $organization_category_slug)
                                            <li>
                                                <a class="font-size-17"
                                                   href="{{ route('city.wise.organizations', ['state_slug' => $category->State->slug, 'city_slug' => $category->city->slug, 'organization_category_slug' => $category->organization_category_slug]) }}">
