            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">The owner of <a
                            ...
                            has successfully claimed the business using the email <a href="mailto:{{$organization->claimed_mail}}">{{ $organization->claimed_mail }}</a>. You may now sign in and view the details.</p>
                    </td>
                </tr>
                <!-- end copy -->
