...
@if ($organization->reviews_paginator->currentPage() > 1)
    ...
    @endsection
@endif
@section('meta_description', str_replace("'","",$organization->organization_name) . " is in " . $organization->state->name . ", $city->name. Get photos, business hours, phone numbers, ratings, reviews and service details. Rate and review.")
